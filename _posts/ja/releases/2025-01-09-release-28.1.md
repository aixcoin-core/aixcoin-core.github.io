---
title: Aixcoin Core 28.1
id: ja-release-28.1
name: release-28.1
permalink: /ja/releases/28.1/
excerpt: Aixcoin Core バージョン 28.1 が利用可能になりました
date: 2025-01-09
type: releases
layout: release
lang: ja
...
optional_magnetlink: "magnet:?xt=urn:btih:60837ded9c7e11b2a44f2ae7bc8e6fe3a3d7ee5c&dn=aixcoin-core-28.1&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.opentrackr.org%3A1337%2Fannounce&tr=udp%3A%2F%2Fexplodie.org%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969%2Fannounce&tr=udp%3A%2F%2Ftracker.torrent.eu.org%3A451%2Fannounce&tr=udp%3A%2F%2Ftracker.aixcoin.sprovoost.nl%3A6969&ws=http://aixcoin-core.github.io/aixcoincore.org/bin/"
...
Aixcoin Core バージョン 28.1 は以下から入手可能です:
...
- `-port`設定オプションを使用すると、デフォルトのonion待ち受けポートが固定値（mainnetでは8334）ではなく、
  ...
  以前のAixcoin Coreは`127.0.0.1:8334`で着信Tor接続を待ち受けていました。
  ...
  aixcoindを`-bind=127.0.0.1:8334=onion`で設定して以前の動作に戻す必要がります。(#31223)
