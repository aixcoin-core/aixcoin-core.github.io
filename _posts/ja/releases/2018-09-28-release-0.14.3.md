---
title: Aixcoin Core 0.14.3
id: ja-release-0.14.3
name: release-0.14.3
permalink: /ja/releases/0.14.3/
excerpt: Aixcoin Core バージョン 0.14.3 が利用可能になりました
type: releases
layout: release
lang: ja
...
Aixcoin Core バージョン *0.14.3* は以下から入手可能です。
...
0.14.0からコインコントロールおよびスマート手数料見積もりを使用した場合、Aixcoin-Qtに表示される
