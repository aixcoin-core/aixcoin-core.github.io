---
title: Aixcoin Core 0.19.1
id: ja-release-0.19.1
name: release-0.19.1
permalink: /ja/releases/0.19.1/
excerpt: Aixcoin Core バージョン 0.19.1 が利用可能になりました
type: releases
layout: release
lang: ja
date: 2020-03-09
...
# Release notes from aixcoin/aixcoin 58ba7c314d552cea8cb024960a8504577aee586f
...
Aixcoin Core バージョン 0.19.1 は以下から入手可能です。
...
Aixcoin CoreはmacOS 10.10以降を必要とするQt 5.9.xを使ってビルドされているため、
Aixcoin Core 0.17.0以降、10.10より前のmacOSバージョンはサポートされなくなりました。
また、macOSの「ダークモード」が有効になっている場合、Aixcoin Coreの外観はまだ変更されません。
