---
title: Taprootのアクティベーションコードを実装したAixcoin Core 0.21.1をリリース
...
excerpt: >
  Taprootのアクティベーションと適用をサポートするAixcoin Core 0.21.1が利用可能になりました。
---
Aixcoin Core バージョン 0.21.1が[ダウンロード][download page]できるようになりました。
...
**注:** Windows版のAixcoin Coreのコード署名証明書を提供する認証局の[問題][wincodesign]により、
...
[wincodesign]: https://github.com/aixcoin-core/gui/issues/252#issuecomment-802591628
