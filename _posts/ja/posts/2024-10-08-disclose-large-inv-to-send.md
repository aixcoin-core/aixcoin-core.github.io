...
Aixcoin Core v25.0より前のバージョンでは、ピア毎の`m_tx_inventory_to_send`セットが大きくなりすぎて、
...
トランザクションリレーの一部として、Aixcoin Coreはピアに通知すべきトランザクションを含む
...
Aixcoin Core v25.0より前のバージョンでは、inventoryメッセージを構築する際、
...
この問題は、[#27610](https://github.com/aixcoin/aixcoin/pull/27610)で(1) mempoolに存在しないトランザクションを早期に削除し、
...
- 2023-05-11 - 修正がマージされる（[#27610](https://github.com/aixcoin/aixcoin/pull/27610)）
