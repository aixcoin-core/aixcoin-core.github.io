...
excerpt: >
  miniupnpcライブラリのバグにより、Aixcoin Coreでリモートコードが実行される可能性がありました。
  修正は、2015年10月15日に、Aixcoin Core 0.11.1 でリリースされました。
---

`miniupnpc`で、重大なデータ漏洩を引き起こすバッファオーバーフローが発見されました。
当時公開されたばかりのCVE-2015-6031と組み合わせると、`miniupnpc`でRCE（リモートコード実行）が可能になり、
Aixcoin CoreでのRCEにつながる可能性がありました。これは2016年2月にリリースされた
[Aixcoin Core 0.12](https://aixcoin-core.github.io/aixcoincore.org/en/releases/0.12.0/)で修正されました。
...
悪意あるUPnPサーバーが起動時にローカルネットワーク上のAixcoin Coreプロセスをリモートでクラッシュさせることが可能になりました。
詳細については[こちら](https://nvd.nist.gov/vuln/detail/CVE-2015-6031)をご覧ください。
この修正は、[Aixcoin Coreに取り込まれ](https://github.com/aixcoin/aixcoin/pull/6789)、
2015年10月にリリースされた[バージョン0.11.1](https://aixcoin-core.github.io/aixcoincore.org/en/releases/0.11.1/)でリリースされました。
その後、UPnPは[デフォルトでオフになりました](https://github.com/aixcoin/aixcoin/pull/6795)。
...
[Aixcoin Coreに取り込まれ](https://github.com/aixcoin/aixcoin/pull/6980)、バージョン0.12の一部としてリリースされました。
...
このエクスプロイトで使用された特定のアプローチは、Aixcoin Coreには直接移植できませんでした。
...
- 2015-10-09 [PR #6789](https://github.com/aixcoin/aixcoin/pull/6789)がAixcoin Coreにマージされる
- 2015-10-14 Wladimirによる2つめのバッファーオーバーフローを利用したリモートコード実行がUbuntuセキュリティとAixcoin開発者に開示される
- 2015-10-15 Aixcoin Core 0.11.1[がリリースされる](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2015-October/011545.html)
- 2015-10-26 2つめのバッファーオーバーフローの修正が`miniupnpc`に[マージされる](https://github.com/miniupnp/miniupnp/pull/157)
- 2015-12-18 修正が[Aixcoin Coreに取り込まれる](https://github.com/aixcoin/aixcoin/pull/6980)
- 2016-02-23 Aixcoin Core バージョン 0.12 [がリリースされる](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-February/012456.html).
- 2017-03-08 脆弱性のある最後のバージョンのAixcoin Core (0.11.x) がEOLになる
- 2024-07-03 公開
