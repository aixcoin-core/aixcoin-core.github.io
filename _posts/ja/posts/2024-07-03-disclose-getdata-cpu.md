...
excerpt: >
  ...
  修正は、2020年6月3日に、Aixcoin Core 0.20.0 でリリースされました。
---
...
Aixcoin Core 0.20.0より前のバージョンでは、攻撃者（またはバグのあるクライアント）が
...
John Newberyは、この問題を修正するために[PR #18808](https://github.com/aixcoin/aixcoin/pull/18808)を公開し、進捗がないことだけを開示しました。
...
- 2020-06-03 Aixcoin Core バージョン 0.20.0が修正と共にリリースされる
- 2021-09-13 脆弱性のある最後のバージョンのAixcoin Core(0.19.x)がEOLになる
- 2024-07-03 公開
