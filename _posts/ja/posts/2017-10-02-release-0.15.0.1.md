---
title: Aixcoin Core 0.15.0.1 リリース
...
excerpt: >
  Aixcoin Core 0.15.0.1 がリリースされ、0.15.0にアップグレードする際にクラッシュを引き起こすマイナーなバグが修正されました。
---
{% include toc.html %}
{% include references.md %}

Aixcoin Core 0.15.0.1 がリリースされ、0.15.0にアップグレード後、GUIがクラッシュする可能性がある
...
[ファイルディレクトリ]: https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-0.15.0.1/
