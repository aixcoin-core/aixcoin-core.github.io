---
title: Aixcoin Core 0.16.0 リリース
...
excerpt: >
  Aixcoin Core 0.16.0がリリースされ、ウォレットでsegwitがサポートされるようになりました。

---
{% include toc.html %}
{% include references.md %}

Aixcoin Coreのウォレットでsegregated witness(segwit)をデフォルトサポートした最初のバージョンである
