...
Aixcoin 核心项目按照开放式贡献者模式运作，欢迎任何人以同行评价、测试和打补丁的形式为它的发展做出贡献。本文档说明了做出贡献的操作流程和指导。
...
必须遵守 [开发手册](https://github.com/aixcoin/aixcoin/blob/master/doc/developer-notes.md) 规定的项目代码规范。
