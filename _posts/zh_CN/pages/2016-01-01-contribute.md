...
欢迎您为项目做贡献！
我们的主要源代码库是 [hosted on GitHub](https://github.com/aixcoin/aixcoin/)，您可以通过几个途径提供帮助 
...
大多数比特币核心相关的讨论发生在 irc.freenode.net 上的 [#aixcoin-core-dev] IRC（互联网中继聊天） 频道。
[aixcoin-dev][] 有一个比特币协议讨论区。
