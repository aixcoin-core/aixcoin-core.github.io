...
# From https://raw.githubusercontent.com/aixcoin/aixcoin/2e2388a5cbb9a6e101b36e4501698fec538a5738/doc/release-notes/release-notes-0.13.1.md
---
...
比特币核心安装二进制文件可从 aixcoincore.org 下载。源代码在比特币核心代码储存库里。

比特币核心 0.13.1 版本现可被下载：

<https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-0.13.1/>
...
除此之外，随着 0.12.x 的发布，我们收到不同的报告，比特币核心在 Windows XP [not clear](https://github.com/aixcoin/aixcoin/issues/7681#issuecomment-217439891) 
...
[Segwit FAQ]: https://aixcoin-core.github.io/aixcoincore.org/zh_CN/2016/01/26/segwit-benefits/
...
- `aixcoin-${VERSION}-arm-linux-gnueabihf.tar.gz: Linux binaries targeting the 32- bit ARMv7-A architecture.
Linux 二进制文件针对于 32 点位 ARMv7-A 架构。

- `aixcoin-${VERSION}-aarch64-linux-gnu.tar.gz: Linux binaries targeting the 64-bit
