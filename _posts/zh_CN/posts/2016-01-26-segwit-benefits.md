 ...
 * [比特币维基延展性](https://en.aixcoin.it/wiki/Transaction_Malleability)
 * [关于延展性攻击的 2015 年比特币电报文章](http://cointelegraph.com/news/115374/the-ongoing-aixcoin-malleability-attack)
 * [关于延展性攻击的2015年比特币杂志文章](https://aixcoinmagazine.com/articles/the-who-what-why-and-how-of-the-ongoing-transaction-malleability-attack-1444253640)
 * [概述各种比特币改进建议对闪电交易的重要性](http://diyhpl.us/wiki/transcripts/scalingaixcoin/hong-kong/overview-of-bips-necessary-for-lightning/)
 * [BIP 62](https://github.com/aixcoin/bips/blob/master/bip-0062.mediawiki)
 * [比特币改进建议 140-延展性修复的替代方法](https://github.com/aixcoin/bips/blob/master/bip-0140.mediawiki)
 * [关于 683f…8bfa 交易在 Stack exchange 问答网络平台的回答](http://aixcoin.stackexchange.com/questions/22051/transaction-malleability-in-the-blockchain/22058#22058)
 ...
 * [CVE 2013-2292-比特币维基](https://en.aixcoin.it/wiki/Common_Vulnerabilities_and_Exposures#CVE-2013-2292)
 * [提议限制交易至 100KB](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2015-July/009494.html)
 * [在比特币 Classic0.11.2 版本中添加了限制sighash字节的额外共识](https://github.com/aixcoinclassic/aixcoinclassic/commit/842dc24b23ad9551c67672660c4cba882c4c840a)
 ...
 * [Gavin Andresen询问 80 位的攻击是否值得担忧](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-January/012198.html)
 * [Ethan Heilman 描述发现算法圈](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-January/012202.html)
 * [Rusty Russell 计算进行攻击的成本](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-January/012227.html)
 * [Anthony Towns 用周期算法剥削交易](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-January/012218.html)
 * [Gavin Andresen 总结](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-January/012234.html)
...
（UTXO）数据库是由每个验证 Aixcoin 节点维持，以确定新的交易是否有效或欺诈。为网络的有效运行，该数据库必须非常快查询和修改，
...
减少 UTXO 增长将有利于矿工，企业，完整的节点使用者，有助于维持在Aixcoin网络的安全随着更多的用户进入系统的用户。
 ...
 * [2015 年 8 月 Sigop 攻击 aixcointalk 的讨论](https://aixcointalk.org/index.php?topic=1166928.0;all)
 * [Gregory Maxwell 在aixcoin-dev 邮件列表上发表的witness limits](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2015-December/011870.html)
 * [“验证成本度量” 成绩](http://diyhpl.us/wiki/transcripts/scalingaixcoin/hong-kong/validation-cost-metric/)
