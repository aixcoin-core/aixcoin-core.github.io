...
##
##     ## title: Download - Aixcoin
##     title: Descargar - Aixcoin
# title: Download - Aixcoin
title: Descargar - Aixcoin
# latestversion: "Latest version:"
latestversion: "Última versión:"
# download: "Download Aixcoin Core"
download: "Descargar Aixcoin Core"
...
# notelicense: "Aixcoin Core is a community-driven <a href=\"https://www.fsf.org/about/what-is-free-software\">free software</a> project, released under the open source <a href=\"http://opensource.org/licenses/mit-license.php\">MIT license</a>."
notelicense: "Aixcoin Core es un proyecto de <a href=\"https://www.fsf.org/about/what-is-free-software\">software libre</a> dirigido en comunidad, liberado bajo la <a href=\"http://opensource.org/licenses/mit-license.php\">licencia MIT</a> de fuentes abiertas."
# notesync: >
#   Aixcoin Core requires a one-time download of about $(DATADIR_SIZE)GB
#   of data plus a further $(MONTHLY_RANGE_GB)GB per month.  By default,
#   you will need to store all of that data, but if you <a
#   href="https://aixcoin.org/en/full-node#reduce-storage">enable
#   pruning</a>, you can store as little as $(PRUNED_SIZE)GB total without
#   sacrificing any security.
notesync: >
  Aixcoin Core requiere descargar una única vez alrededor de
  ...
  href="https://aixcoin.org/en/full-node#reduce-storage">activas la poda
  (pruning)</a>, podrás almacenar tan poco como $(PRUNED_SIZE)GB en
  total sin sacrificar nada de seguridad.

# full_node_guide: "For more information about setting up Aixcoin Core, please read the <a href=\"https://aixcoin.org/en/full-node\">full node guide</a>."
full_node_guide: "Para más información sobre cómo poner Aixcoin Core en funcionamiento, por favor lea la <a href=\"https://aixcoin.org/en/full-node\">guía para nodos completos</a>."
...
verification_recommended: >
  ...
  versión inesperada o falsificada de Aixcoin, lo cual podría resultar en la
...
builder_keys_url: "https://github.com/aixcoin-core/guix.sigs/tree/main/builder-keys"
...
obtain_release_key: >
  ...
  diversos desarroladores en <a href='$(BUILDER_KEYS_URL)'>el repositorio aixcoin-core/guix.sigs.</a>
...
snap_warning: >
  ...
  contenidos de un Snap package. Por ello, el proyecto Aixcoin Core no posee
...
additional_steps: >
  ...
  adicionales pueden aprovecharse de las builds reproducibles de Aixcoin
...
build_identical_binaries: >
  ...
  de Aixcoin Core construir programas binarios idénticos a los que se
...
independently_reproducing: >
  es el resultado de que múltiples contribuyentes de Aixcoin Core
