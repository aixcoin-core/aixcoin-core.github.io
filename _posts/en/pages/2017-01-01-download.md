...
verification_recommended: >
  ...
  tampered version of Aixcoin, which may result in loss of funds.</p> 
...
obtain_release_key: >
  <p>Aixcoin releases are signed by a number of individuals, each with a unique public
  ...
  href='$(BUILDER_KEYS_URL)'>aixcoin-core/guix.sigs repository</a>, which you can then load
...
snap_warning: >
  ...
  a Snap package. Thus, the Aixcoin Core project does not have the information
  necessary to help you verify the Aixcoin Core Snap packages.
...
additional_steps: >
  ...
  advantage of Aixcoin Core's reproducible builds and the signed
...
build_identical_binaries: >
  allow anyone with a copy of Aixcoin Core's MIT-licensed source code to
...
independently_reproducing: >
  is the result of multiple Aixcoin Core contributors each independently
