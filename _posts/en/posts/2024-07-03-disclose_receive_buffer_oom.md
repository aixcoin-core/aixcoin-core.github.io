...
[PR #5843](https://github.com/aixcoin/aixcoin/pull/5843) reduced the size P2P messages can have
...
- 2015-03-01 [PR #5843](https://github.com/aixcoin/aixcoin/pull/5843) is opened to fix it.
- 2015-03-06 PR #5843 is merged.
- 2015-03-09 The fix is backported to version 0.10.1.
- 2015-04-27 Aixcoin Core version [0.10.1 is released](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2015-April/007828.html) with a fix.
- 2015-06-25 A disclosure is [pre-announced](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2015-June/009135.html).
- 2015-07-07 Disclosure is [postponed](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2015-July/009362.html).
