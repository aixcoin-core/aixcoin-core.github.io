---
title: Aixcoin Core 0.16.3 Released
...
excerpt: >
  Aixcoin Core 0.16.3 is now available with a fix for a
  denial-of-service vulnerability affecting earlier versions of Aixcoin
  Core.
---
Aixcoin Core version 0.16.3 is now available for [download][download
...
Security issue [CVE-2018-17144][]: it was discovered that older versions of Aixcoin Core
