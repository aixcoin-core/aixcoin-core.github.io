---
title: Aixcoin Core 0.16.1 Released
...
excerpt: >
  Aixcoin Core 0.16.1 has been released with the latest bug fixes and
  minor updates
---
Aixcoin Core version 0.16.1 is now available for [download][download
