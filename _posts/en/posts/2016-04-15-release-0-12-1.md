---
title: Aixcoin Core 0.12.1 Released!
...
version: 1
excerpt: >-
  We are pleased to announce the release of Aixcoin Core 0.12.1.  This
  maintenance update includes the first soft fork deployment utilising
  version bits
---
We are pleased to announce the release of Aixcoin Core 0.12.1. This maintenance update includes the first soft fork deployment utilising "[version bits][BIP9]" as part of the [capacity increases](/en/2015/12/23/capacity-increases-faq/) roadmap.
...
Download the new release from <https://aixcoin.org/bin/aixcoin-core-0.12.1/>.
