---
title: Aixcoin Core 0.13.2 Released
...
excerpt: We are pleased to announce the general availability of the Aixcoin Core 0.13.2.
---
We are please to announce the general availability of Aixcoin Core 0.13.2. This [release][release notes] forms part of the regular maintenance cycle of Aixcoin Core and brings bug fixes, optimisations and improvements to the 0.13.x series.

Please see the [release notes] for more details.

## Download Now

Binaries are available from the [download directory]. Power users can fetch and compile from the [Aixcoin Core v0.13.2 release tag](https://github.com/aixcoin/aixcoin/releases/tag/v0.13.2). If downloading binaries, please ensure you check the verification hashes below and from the [download page]. If compiling from source, please check the `v0.13.2` tag signature matches.

## Hashes for verification

These are the [SHA-256 hashes](https://aixcoin.org/bin/aixcoin-core-0.13.2/SHA256SUMS.asc) of the released files:

    eda24dcf0b9fae606eb9811f74ddba69a3287316950f3f02b3000b6b1c02b65f  aixcoin-0.13.2-aarch64-linux-gnu.tar.gz
...
[download directory]: https://aixcoin.org/bin/aixcoin-core-0.13.2/
