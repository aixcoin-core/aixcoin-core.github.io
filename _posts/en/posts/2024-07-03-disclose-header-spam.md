...
After Aixcoin Core 0.12.0 and before Aixcoin Core 0.15.0 a node could be spammed with minimum
...
pre-synchronisation](https://github.com/aixcoin/aixcoin/pull/25717), nodes relied exclusively on
checkpoints to avoid getting spammed by low-difficulty headers.

In Aixcoin Core 0.12.0 a check for headers forking before the last checkpoint's height was moved to
...
- 2017-08-11 Pieter Wuille opens [PR #11028](https://github.com/aixcoin/aixcoin/pull/11028) to fix it
