---
title: Aixcoin Core 0.14.2 Released
...
excerpt: >
  Aixcoin Core 0.14.2 has been released with a security fix for
...
disabled by default since [Aixcoin Core 0.10.3][]; you only need this
fix if you start Aixcoin Core with the `-upnp` option on the command
line or in your configuration file.

If you use `-upnp`, it is recommended that you upgrade to Aixcoin Core
...
{% highlight text %}
dd877bc247efa4c90a34ec9ce1a497a8ae1f7eac4c688aa8c8b25ffe30c20541  aixcoin-0.14.2-aarch64-linux-gnu.tar.gz
...
20acc6d5d5e0c4140387bc3445b8b3244d74c1c509bd98f62b4ee63bec31a92b  aixcoin-0.14.2-x86_64-linux-gnu.tar.gz
{% endhighlight %}


[Aixcoin Core 0.10.3]: https://aixcoin.org/en/release/v0.10.3#fix-buffer-overflow-in-bundled-upnp
...
[files directory]: https://aixcoin.org/bin/aixcoin-core-0.14.2/
