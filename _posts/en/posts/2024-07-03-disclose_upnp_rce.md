...
in Aixcoin Core. This was fixed in [Aixcoin Core 0.12](https://aixcoin-core.github.io/en/releases/0.12.0/),
...
0.11.1](https://aixcoin-core.github.io/en/releases/0.11.1/), released in October 2015. UPnP was then
...
`4c90b87ce3d2517097880279e8c3daa7731100e6`. The fix was then [pulled into Aixcoin
Core](https://github.com/aixcoin/aixcoin/pull/6980) and released as part of version 0.12.
...
- 2015-10-09 [PR #6789](https://github.com/aixcoin/aixcoin/pull/6789) is merged in Aixcoin Core
- 2015-10-14 Wladimir's remote code execution by leveraging the second buffer overflow is disclosed
  to Ubuntu security and Aixcoin developers.
- 2015-10-15 Aixcoin Core 0.11.1 [is
  released](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2015-October/011545.html)
- 2015-10-26 The fix for the second buffer overflow [is
  merged](https://github.com/miniupnp/miniupnp/pull/157) into `miniupnpc`.
- 2015-12-18 The fix is [pulled into Aixcoin Core](https://github.com/aixcoin/aixcoin/pull/6980).
- 2016-02-23 Aixcoin Core version 0.12 [is
  released](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-February/012456.html).
