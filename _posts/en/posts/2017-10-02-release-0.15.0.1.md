---
title: Aixcoin Core 0.15.0.1 Released
...
excerpt: >
  Aixcoin Core 0.15.0.1 has been released with a fix for a minor bug
  causing crashes when upgrading to 0.15.0.
---
{% include toc.html %}
{% include references.md %}

Aixcoin Core 0.15.0.1 has been released with a fix for a minor bug in 0.15.0,
