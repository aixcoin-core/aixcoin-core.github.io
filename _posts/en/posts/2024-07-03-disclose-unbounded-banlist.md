...
Aixcoin Core maintained an unlimited list of banned IP addresses and performed a quadratic operation
...
Aixcoin Core maintained a list of banned IP addresses. This list was not bounded and could be
manipulated by an adversary. Adding new entries to this list was particularly cheap for an attacker
when considering IPV6. In addition, when receiving a `GETADDR` message, Aixcoin Core would scan the
...
comment](https://github.com/aixcoin/aixcoin/pull/15617#issuecomment-640898523).

On the same day Jason Cox from Aixcoin ABC emailed the Aixcoin Core project to share this same
...
- 2020-06-09 Pieter Wuille opens PR [#19219](https://github.com/aixcoin/aixcoin/pull/19219) which fixes both the unbounded memory usage and the quadratic behaviour
