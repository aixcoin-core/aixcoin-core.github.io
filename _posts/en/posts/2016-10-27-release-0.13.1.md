...
- **September 2016** saw adoption of Aixcoin Core 0.13.0 (containing compact blocks) starting to be used in production, with over 1,300 Aixcoin Core 0.13.0 nodes accepting incoming connections by the end of the month.  Also by the end of the month, a number of programs besides Aixcoin Core---including the btcd full node and many commonly-used mining programs---had code ready to upgrade to segwit and were actively being used to generate blocks on testnet.
