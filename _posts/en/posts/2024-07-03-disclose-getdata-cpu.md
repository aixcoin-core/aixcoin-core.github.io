...
Before Aixcoin Core 0.20.0, an attacker (or buggy client, even) could send us a `GETDATA` message
...
John Newbery opened [PR #18808](https://github.com/aixcoin/aixcoin/pull/18808) to fix this issue by
