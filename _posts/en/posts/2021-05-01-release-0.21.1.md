---
title: Aixcoin Core 0.21.1 Released With Taproot Activation Code
...
excerpt: >
  Aixcoin Core 0.21.1 is now available with support for activating and
  enforcing taproot.
---
Aixcoin Core version 0.21.1 is now available for [download][download
