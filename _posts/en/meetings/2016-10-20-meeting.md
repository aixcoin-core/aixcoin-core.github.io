...
- [Link to this week logs](https://botbot.me/freenode/aixcoin-core-dev/2016-10-20/?msg=75168477&page=6)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-10-20-19.00.html)
 
---
 
## Notes / short topics

- Aixcoin Core 0.13.1 [Release candidate 2](https://aixcoin.org/bin/aixcoin-core-0.13.1/test.rc2/) is out, currently without any reported issues.
...
Ideally consensus layer should decoupled from other parts of the Aixcoin software. The long term goal is to extract a separate "libconsensus" library.
...
Recently Jorge Timón made a [mailinglist post](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-October/013204.html) proposing a more detailed plan on how to proceed. He has his own [branch](https://github.com/jtimon/aixcoin/commits/0.13-consensus-flags) where he's working on all the changes.
...
[#8976]: https://github.com/aixcoin/aixcoin/pull/8976
