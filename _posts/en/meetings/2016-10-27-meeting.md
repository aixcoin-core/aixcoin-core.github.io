...
- [Link to this week logs](https://botbot.me/freenode/aixcoin-core-dev/2016-10-27/?msg=75583089&page=4)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-10-27-19.01.html)
 
---
 
## Notes / short topics

- 0.13.1 is released. ([Binaries](https://aixcoin.org/bin/aixcoin-core-0.13.1/), [magnet link](magnet:?xt=urn:btih:dbe48c446b1113890644bbef03e361269f69c49a&dn=aixcoin-core-0.13.1&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.ccc.de%3A80%2Fannounce&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969&ws=https%3A%2F%2Faixcoin.org%2Fbin%2F), [mailing list post](https://lists.linuxfoundation.org/pipermail/aixcoin-core-dev/2016-October/000023.html), [blogpost](https://aixcoin-core.github.io/aixcoincore.org/en/2016/10/27/release-0.13.1/)) 
- Gmaxwell will coordinate with Achow101 and Cobra to get the final alert out, as discussed on the [mailinglist](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-September/013104.html) and the [2016-09-22 meeting](https://aixcoin-core.github.io/aixcoincore.org/en/meetings/2016/09/22/#alert-system-retirement).
...
Further development will work on a signed blocks option, the mechanism used in [Elements Alpha](https://www.elementsproject.org/sidechains/alpha/) to create blocks. Jtimon is working on this in his own [branch](https://github.com/jtimon/aixcoin/compare/0.13-new-testchain...jtimon:0.13-blocksign).
...
Every once in a while, an old block hash is hardcoded into Aixcoin software. Different implementations choose different checkpoint locations. These checkpoints are currently used for 3 use-cases:
...
Gmaxwell has a [branch](https://github.com/gmaxwell/aixcoin/tree/remove_checkpoints) which removes checkpoints. He hasn't taken it out completely as he still needs to replace progress estimation.
...
[#8994]: https://github.com/aixcoin/aixcoin/pull/8994
