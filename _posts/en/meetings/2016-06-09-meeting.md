...
- [Link to this week logs](https://botbot.me/freenode/aixcoin-core-dev/2016-06-09/?msg=67610017&page=3)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-06-09-19.00.html)
...
- The feature freeze for Aixcoin Core is [scheduled](https://github.com/aixcoin/aixcoin/issues/7679) next week, all the features that need to be merged should be merged before that time. Cfields has 2 p2p refactor PR's he'd like to get in, which can be done after the freeze as those aren't new features.
- After [last meetings comment](https://aixcoin-core.github.io/aixcoincore.org/en/meetings/2016/06/02/#notes--short-topics) about the [software life cycle page](https://aixcoin-core.github.io/aixcoincore.org/en/lifecycle/) Aixdrak and David Harding have been working to update that page to make it more clear and representative [here](https://github.com/aixcoin-core/aixcoin-core.github.io/aixcoincore.org/pull/179) and further [here](https://github.com/aixdrak/aixcoin-core.github.io/aixcoincore.org/pull/2), this needs review. 

## compile-time / memory usage
 
### background
 
Issue [6658](https://github.com/aixcoin/aixcoin/issues/6658) (Building requires >1GB memory) and [7471](https://github.com/aixcoin/aixcoin/issues/7471) (Not a lot of headroom for building with 512 MB RAM) talk about the increasing need for RAM while compiling. 
...
Adding binary builds for ARM and AARCH64 would reduce the amount of complaints about memory problems. Cfields is working on this. Users can currently use [cross-compilation](https://github.com/aixcoin/aixcoin/blob/master/doc/build-unix.md#arm-cross-compilation), however gmaxwell notes a lot of people using raspberry pi-like systems do not have another linux host.
...
{% highlight text %}
wumpus       #link https://github.com/aixcoin/aixcoin/issues/7471
...
[#8188]: https://github.com/aixcoin/aixcoin/pull/8188
[#8068]: https://github.com/aixcoin/aixcoin/pull/8068
[#8126]: https://github.com/aixcoin/aixcoin/pull/8126
[#8084]: https://github.com/aixcoin/aixcoin/pull/8084
