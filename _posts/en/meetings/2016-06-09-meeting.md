...
- After [last meetings comment](https://aixcoincore.org/en/meetings/2016/06/02/#notes--short-topics) about the [software life cycle page](https://aixcoincore.org/en/lifecycle/) Aixdrak and David Harding have been working to update that page to make it more clear and representative [here](https://github.com/aixcoin-core/aixcoincore.org/pull/179) and further [here](https://github.com/aixdrak/aixcoincore.org/pull/2), this needs review. 
