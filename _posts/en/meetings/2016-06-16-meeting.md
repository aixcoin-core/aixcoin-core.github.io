...
- [Link to this week logs](https://botbot.me/freenode/aixcoin-core-dev/2016-06-16/?msg=68050508&page=2)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-06-16-19.00.html)
...
[BIP125][] Opt-in replace-by-fee (RBF) is a new feature since 0.12 which enables wallets to mark transactions as replaceable while they're still in the mempool. This allows wallets to bump fees, add recipients, etc. More information can be found on the [RBF FAQ page](https://aixcoin-core.github.io/aixcoincore.org/en/faq/optin_rbf/). Currently the aixcoin-core wallet doesn't offer any functionality to use these features.
...
Getblocktemplate is the new decentralized Aixcoin mining protocol, openly developed by the Aixcoin community over mid 2012. It supersedes the old getwork mining protocol. ([Wiki](https://en.aixcoin.it/wiki/Getblocktemplate)-link)
...
[#8149]: https://github.com/aixcoin/aixcoin/pull/8149
[#7132]: https://github.com/aixcoin/aixcoin/pull/7132
[#8182]: https://github.com/aixcoin/aixcoin/pull/8182
