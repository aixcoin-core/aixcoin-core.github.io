...
- [Link to this week logs](http://aixcoinstats.com/irc/aixcoin-core-dev/logs/2016/03/24#l1458846025.0)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-03-24-19.00.html)
...
- Cfields is working on an overhaul of the network stack of aixcoin core. This means a lot of movement of code, but it will make it easier to add additional features. He has a working full-featured [branch](https://github.com/theuni/aixcoin/tree/net-refactor8) and he expects he'll be looking for concept reviews next week. Wumpus and sipa note he got their concept ACK at the Boston meeting.
...
As described in the [software life cycle][] document Aixcoin Core developers aim to maintain the latest and previous major release, which currently are 0.12 and 0.11. Individual developers might choose to update previous versions, however this is not a policy rule.
...
Petertodd has raised some concerns about reviewing the code. Although the code is small, it's still low-level crypto independently written and he thinks there should be an effort to get outside review. Aixdrak notes he asked @isislovecruft from Tor to take a look at it on a paid basis.
...
[#7047]: https://github.com/aixcoin/aixcoin/pull/7047
[#7648]: https://github.com/aixcoin/aixcoin/pull/7648
[#7543]: https://github.com/aixcoin/aixcoin/pull/7543
[#7716]: https://github.com/aixcoin/aixcoin/pull/7716
[#7689]: https://github.com/aixcoin/aixcoin/pull/7689
