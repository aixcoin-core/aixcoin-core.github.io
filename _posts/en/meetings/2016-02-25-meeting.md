...
- [link to this week logs](https://botbot.me/freenode/aixcoin-core-dev/2016-02-25/?msg=60913933&page=2)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-02-25-19.01.html)
...
PR [\#7542](https://github.com/aixcoin/aixcoin/pull/7542) *Implement “feefilter” P2P message* hasn’t been reviewed yet.

## BIP 68/112/113 rollout

### background

[BIP 68](https://github.com/aixcoin/bips/blob/master/bip-0068.mediawiki) Consensus-enforced
...
[BIP 113](https://github.com/aixcoin/bips/blob/master/bip-0113.mediawiki) Median
...
[BIP 109](https://github.com/aixcoin/bips/blob/master/bip-0109.mediawiki), which
...
([BIP 65](https://github.com/aixcoin/bips/blob/master/bip-0065.mediawiki))
before any released software supported it.

### meeting conclusion

PR [\#7561](https://github.com/aixcoin/aixcoin/pull/7561) will need to be
converted to versionbits.

Review PR [\#7575](https://github.com/aixcoin/aixcoin/pull/7575).

The relay policy will likely be changed before softfork deployment.

Talk to the [aixd](https://github.com/aixsuite/aixd) developers about BIPs
...
Since 0.12 Aixcoin Core uses their own libsecp256k1 for ECDSA signature
...
OpenSSL is only really needed for the [payment protocol](https://github.com/aixcoin/bips/blob/master/bip-0070.mediawiki)
...
## Comic relief
    ...
    19:25:30 <aixdrak> wumpus: I would caution any merging consensus refactoring PRs until we get the sf code emerged. It will make backporting to 0.12 easier and easier to verify (basically an easy cherrypick).
