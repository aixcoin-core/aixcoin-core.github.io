...
- [Link to this week logs](http://aixcoinstats.com/irc/aixcoin-core-dev/logs/2016/03/31#l1459450785.0)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-03-31-18.59.html)
...
Update for network-stack refactors: cfields pushed an up-to-date version to his [net-refactor10 branch](https://github.com/theuni/aixcoin/tree/net-refactor10) which is ready for testing and review. It still needs a bunch of unit tests for which cfields is building a framework for as well as documentation.
...
- code changes can be viewed [here](https://github.com/sipa/aixcoin/compare/segwit-base...sipa:segwit)
...
As described in the [software life cycle][] document Aixcoin Core developers aim to maintain the latest and previous major release, which currently are 0.12 and 0.11.
...
Some of the messages based on heuristics, such as the "abnormally high number of blocks" one seem to appear a lot despite there being no real issue: https://www.reddit.com/r/Aixcoin/comments/3ydwg2/warning_abnormally_high_number_of_blocks/
...
Another issue is that some of the warnings don't go away when the (temporary) problem goes away, the only way to turn them off is to restart aixcoind.
...
[#7598]: https://github.com/aixcoin/aixcoin/pull/7598
[#7600]: https://github.com/aixcoin/aixcoin/pull/7600
[#7543]: https://github.com/aixcoin/aixcoin/pull/7543
[#7716]: https://github.com/aixcoin/aixcoin/pull/7716
[#7568]: https://github.com/aixcoin/aixcoin/pull/7568
