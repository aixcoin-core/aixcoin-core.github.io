...
- View this week's log on [BotBot.me](https://botbot.me/freenode/aixcoin-core-dev/msg/100892716/) or [MeetBot][mb log]
- [Meeting minutes by MeetBot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-06-07-19.00.html)
...
- **[#12136][]:** Implement BIP 174 Partially Signed Aixcoin
...
and introduced it by describing a [recent change][#11862] to how Aixcoin
...
[gitian]: https://github.com/aixcoin-core/gitian.sigs
[rw conf meet notes]: /en/meetings/2018/05/24/#gui-prune-setting-and-writable-config-files

{% assign log = "http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-06-07-19.00.log.html" %}
[mb log]: {{log}}
[log hipri]: {{log}}#l-15
