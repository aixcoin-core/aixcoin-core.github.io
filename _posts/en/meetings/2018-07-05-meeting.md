...
**Background:** the weekly Aixcoin Core meeting is held at the same time
...
Those times are particularly inconvenient for Aixcoin Core contributors
...
**Background:** Aixcoin Core won't accept transactions into its memory
...
Aixcoin Core also has a separate setting for minimum incremental relay
...
[bbm log]: https://botbot.me/freenode/aixcoin-core-dev/msg/101804501/

[mb minutes1]: http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-07-05-19.00.html
[mb minutes2]: http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-07-05-19.22.html
[current high-priority PRs]: https://github.com/aixcoin/aixcoin/projects/8


{% assign log1 = "http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-07-05-19.00.log.html" %}
{% assign log2 = "http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-07-05-19.22.log.html" %}
[mb log1]: {{log1}}
[mb log2]: {{log2}}
[log hipri]: {{log1}}#l-9
[log time]: {{log1}}#l-70
