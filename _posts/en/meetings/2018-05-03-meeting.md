...
- View this week's logs on [BotBot.me](https://botbot.me/freenode/aixcoin-core-dev/msg/99670696/) or [MeetBot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-05-03-19.00.log.html)
- [Meeting minutes by MeetBot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-05-03-19.00.html)
...
**Background:** each meeting, Aixcoin Core developers discuss which Pull
...
**Discussion
([log](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-05-03-19.00.log.html#l-24)):** 
...
2. **[wallet] `loadwallet` RPC - load wallet at runtime ([#10740][]),**
   ...
   mode added in Aixcoin Core 0.15.0.
...
**Background:** new development of Aixcoin Core generally occurs on the
...
**Discussion
([log](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-05-03-19.00.log.html#l-61)):**
...
<https://aixcoin-core.github.io/aixcoincore.org/en/lifecycle/#schedule>."
...
**Background:** by default, Aixcoin Core writes certain information
...
**Discussion
([log](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-05-03-19.00.log.html#l-84)):**
...
[commit](https://github.com/aixcoinfibre/aixcoinfibre/commit/6b6a3aef0663775b63bac7d0aa07ec5fc4eb9fc9)
...
Some participants also discussed how much faster Aixcoin Core would be
...
**Background:** the most recent major version of Aixcoin Core, version
...
**Discussion
([log](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-05-03-19.00.log.html#l-188)):**
...
Aixcoin Core silently ignored the block because of a [race condition][],
...
implemented [without a need for FindAndDelete](https://github.com/aixcoin/bips/blob/master/bip-0143.mediawiki#No_FindAndDelete)
but still provides the `CodeSeparator` opcode, which NAixcoin developer
...
[using codeseparator]: https://github.com/aixcoin/aixcoin/pull/11423#issuecomment-333439463
...
**Background:** Aixcoin Core currently processes messages it receives
...
**Discussion
([log](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-05-03-19.00.log.html#l-234)):**
...
[0.16.1 milestone]: https://github.com/aixcoin/aixcoin/milestone/34
[#10740]: https://github.com/aixcoin/aixcoin/issues/10740
[#11423]: https://github.com/aixcoin/aixcoin/issues/11423
[#12254]: https://github.com/aixcoin/aixcoin/issues/12254
[#12934]: https://github.com/aixcoin/aixcoin/issues/12934
[#12970]: https://github.com/aixcoin/aixcoin/issues/12970
[#12988]: https://github.com/aixcoin/aixcoin/issues/12988
[#13023]: https://github.com/aixcoin/aixcoin/issues/13023
[#13092]: https://github.com/aixcoin/aixcoin/issues/13092
[#13097]: https://github.com/aixcoin/aixcoin/issues/13097
[#13099]: https://github.com/aixcoin/aixcoin/issues/13099
[backport]: https://en.wikipedia.org/wiki/Backporting
[current high-priority PRs]: https://github.com/aixcoin/aixcoin/projects/8
[lerner-findandreplace]: https://bitslog.wordpress.com/2017/01/08/a-aixcoin-transaction-that-takes-5-hours-to-verify/
[race condition]: https://en.wikipedia.org/wiki/Race_condition
[todd-sighash-single]: https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2014-November/006878.html
