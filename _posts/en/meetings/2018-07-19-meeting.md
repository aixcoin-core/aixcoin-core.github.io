...
[`fundrawtransaction`][rpc fundrawtransaction] RPC to use Aixcoin Core's
...
## Aixcoin-seeder under aixcoin-core GitHub organization

**Background:** although Aixcoin uses a peer-to-peer protocol, nodes
...
program called a *Aixcoin seeder.*  The node then connects to those
...
them is maintained by Pieter Wuille and is simply called [aixcoin-seeder][].
...
Aixcoin maintainers have merge rights."
...
## Moving away from Aixcoin.org

**Background:** since the 2009 release of the original Aixcoin software,
...
about the increasingly diverse Aixcoin network.

In December 2015 Aixcoin Core began using its own domain to host its
resources, and later also to host its software releases. Release
announcements and software continue to be mirrored to Aixcoin.org.
...
**Background:** periodically, some members of the Aixcoin Core team hold
...
[bbm log]: https://botbot.me/freenode/aixcoin-core-dev/msg/102255898/
[mb minutes]: http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-07-19-19.02.html

[current high-priority PRs]: https://github.com/aixcoin/aixcoin/projects/8

{% assign log = "http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-07-19-19.02.log.html" %}
[mb log]: {{log}}
[log hipri]: {{log}}#l-13
...
[post-meeting bco]: https://botbot.me/freenode/aixcoin-core-dev/msg/102258762/
...
[0.16.2rc2 bin]: https://aixcoin-core.github.io/aixcoincore.org/bin/aixcoin-core-0.16.2/test.rc2/
[0.17 milestone]: https://github.com/aixcoin/aixcoin/milestone/33
[aixcoin-seeder]: https://github.com/sipa/aixcoin-seeder
