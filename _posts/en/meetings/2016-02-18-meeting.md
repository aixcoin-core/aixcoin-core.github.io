...
- [link to this week logs](https://botbot.me/freenode/aixcoin-core-dev/2016-02-18/?msg=60397355&page=2)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-02-18-19.04.html)
...
Aixdrak suggested arranging open source licenses of the Jetbrains IDEs for C++
...
The concept of a limited mempool was introduced in Aixcoin Core 0.12 to provide
protection against attacks or spam transactions of low fees that are not being
mined. Currently there is a [reject message](https://github.com/aixcoin/bips/blob/master/bip-0061.mediawiki) which
...
Review *Implement "feefilter" P2P message* [\#7542](https://github.com/aixcoin/aixcoin/pull/7542)
...
PR [\#7187](https://github.com/aixcoin/aixcoin/pull/7187) attempts to cache
...
Review/test *Keep reorgs fast for SequenceLocks checks* [\#7187](https://github.com/aixcoin/aixcoin/pull/7187)
