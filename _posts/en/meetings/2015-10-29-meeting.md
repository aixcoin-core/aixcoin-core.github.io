...
Check to see if there's any coordination for the softfork in regards to other clients. [aixd](https://github.com/aixsuite/aixd) is ready for it, [aixcoinj](https://github.com/aixcoinj/aixcoinj) historically hasn't implemented any softforks.  
...
For review purposes aixdrak combined both pull-requests ( https://github.com/aixcoin/aixcoin/compare/master...aixdrak:sequenceandcsv )  
