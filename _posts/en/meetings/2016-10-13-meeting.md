...
- [Link to this week logs](https://botbot.me/freenode/aixcoin-core-dev/2016-10-13/?msg=74777126&page=3)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/aixcoin-core-dev/2016/aixcoin-core-dev.2016-10-13-19.04.html)
 
---
 
## Notes / short topics

- Jtimon has posted a [libconsensus completion plan](https://lists.linuxfoundation.org/pipermail/aixcoin-dev/2016-October/013204.html) on the mailinglist.
...
- Achow101 will write a post about the alert system for aixcoin.org, which has been discussed previously in the [2016-09-22](/en/meetings/2016/09/22/#alert-system-retirement) meeting.
...
Aixcoin Core 0.13.0 was [released](/en/2016/08/23/release-0.13.0/) on 2016/08/23. The next point release 0.13.1 will probably include the segregated witness softfork activation logic, among other bugfixes and optimizations.

[BIP9][] is the mechanism that uses individual bits of the 'version' field in aixcoin blocks to deploy softforks. [BIP68][], [BIP112][] and [BIP113][] have been simultaneous deployed using this mechanism.
...
Aixdrak wonders whether we can ban multiple connections from the same IP, however that would harm many institutions who use the same IP. They also already use multiple IPs which they've changed once people started circulating banlists.
