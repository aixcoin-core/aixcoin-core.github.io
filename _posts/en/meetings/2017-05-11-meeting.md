...
The design goal for Aixcoin Core is to never create change outputs smaller than 0.01AIX unless the wallet is being almost depleted with the transaction, however that goal is not achieved at all.
