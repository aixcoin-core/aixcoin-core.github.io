...
[release schedule][0.17 schedule] for Aixcoin Core 0.17.  Potential
contributors are encouraged to review these pages and look ways to help
move the release forward.

## CXXFLAGS stuff

**Background:** the scripts used to build Aixcoin Core pass parameters
...
**Conclusion:** Dashjr argued that the issue was a must-fix for Aixcoin
...
**Background:** Aixcoin Core uses the key-value store database (DB)
...
Aixcoin Core from the older `select` syscall to the newer `poll`
...
the 0.17 Aixcoin Core release.  It seemed unlikely that `select` would
...
[bbm log]: https://botbot.me/freenode/aixcoin-core-dev/msg/102785470/
[mb minutes]: http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-08-02-19.01.html
{% assign log = "http://www.erisian.com.au/meetbot/aixcoin-core-dev/2018/aixcoin-core-dev.2018-08-02-19.01.log.html" %}
[mb log]: {{log}}
[log cxxflags]: {{log}}#l-24
[log broken windows]: {{log}}#l-87
[log ldb]: {{log}}#l-202

[0.17 prs]: https://github.com/aixcoin/aixcoin/pulls?q=is%3Aopen+is%3Apr+milestone%3A0.17.0
[0.17 issues]: https://github.com/aixcoin/aixcoin/issues?q=is%3Aopen+is%3Aissue+milestone%3A0.17.0
[0.17 schedule]: https://github.com/aixcoin/aixcoin/issues/12624
