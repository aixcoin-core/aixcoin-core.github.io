...
excerpt: Aixcoin Core version 22.0 is now available
date: 2021-09-13
...
- Release binaries are now produced using the new `guix`-based build system.
  The [/doc/release-process.md](https://github.com/aixcoin/aixcoin/blob/master/doc/release-process.md) document has been updated accordingly.
